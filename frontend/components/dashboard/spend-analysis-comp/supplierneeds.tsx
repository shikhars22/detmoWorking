...
import { SpendingByTopSupplierType } from '@/lib/types';
                ...
                <div className="">
                    <TooltipProvider delayDuration={300}>
                        <Tooltip>
                            <TooltipTrigger>
                                <Link
                                    href={`/dashboard/projects/create?CommodityName=${data.CommodityName}&CommodityPartNumber=${data.MaterialNumber}`}
                                >
                                    <SendHorizonal
                                        strokeWidth={1}
                            ...
                            <TooltipContent className="">
                                Create new sourcing project <br /> for this
                                commodity
                            </TooltipContent>
                        </Tooltip>
                    </TooltipProvider>
