        ...
        <div className="bg-background pt-10 p-2   flex flex-col justify-center items-center gap-8">
            ...
            <section className="flex flex-col justify-center md:p-3 p-2 container max-w-screen-md  text-center  gap-5">
                <h1 className=" text-3xl md:text-4xl lg:text-5xl font-bold text-wrap md:px-4 px-2 lg:leading-[60px]">
                    Unlock the{' '}
                    <span className="text-destructive/60"> Power</span> of
                    Strategic Sourcing in Procurement
                    {/* Efficient Procurement */}
                </h1>
                <h2 className="  md:text-lg text-wrap font-normal">
                    Discover your spend insights, evaluate and discover the
                    perfect suppliers with our advanced analytics platform
            ...
            <section className="flex flex-col justify-center md:p-3 p-2 container text-center  gap-5">
                <h3 className="text-lg">
                    Trusted by Procurement Managers Worldwide
                </h3>
                ...
                <div className="container px-5 py-24 mx-auto flex flex-col gap-4">
                    ...
                    <article className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
                        ...
                        <div className="p-2 sm:w-1/2 w-full text-start">
                            ...
                            <h3 className="text-xl font-medium title-font mb-4 text-destructive/70">
                                1. Identify sourcing opportunities by using
                                Spend Analysis
                            </h3>
                            <div className="flex flex-col gap-3 py-4">
                                <div className="bg-muted rounded flex   items-center">
                                    ...
                                    <span className="text-secondary-foreground">
                                        Quickly and clearly identify sourcing
                                        pain points
                                    </span>
                                </div>
                                <div className="bg-muted rounded flex   items-center">
                                ...
                                <div className="bg-muted rounded flex  items-center">
                                    <LucidePlay className="size-4 mr-3 fill-foreground" />
                                    <span className="text-secondary-foreground">
                                        Gain deeper insight into your spending
                                        patterns.
                                ...
                                <div className="bg-muted rounded flex  items-center">
                                    <LucidePlay className="size-4 mr-3 fill-foreground" />
                                    <span className="text-secondary-foreground">
                                        Maximize cost savings and optimize
                                        budget allocation.
                                    </span>
                                </div>
                            </div>
                    ...
                    <article className="flex flex-row-reverse flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
                        ...
                        <div className="p-4 sm:w-1/2 w-full text-start  ">
                            {/* subtitle */}
                            <h3 className="text-xl font-medium title-font mb-4 text-destructive/70">
                                2. Create, collaborate and manage Sourcing
                                Projects
                            </h3>
                            <div className="flex flex-col gap-3 py-4">
                                <div className="bg-muted rounded flex   items-center">
                                ...
                                <div className="bg-muted rounded flex  items-center">
                                    <LucidePlay className="size-4 mr-3 fill-foreground" />
                                    <span className="text-secondary-foreground">
                                        Enhanced Agile Kanban foundation project
                                        management
                                    </span>
                                </div>
                                <div className="bg-muted rounded flex  items-center">
                                    <LucidePlay className="size-4 mr-3 fill-foreground" />
                                    <span className="text-secondary-foreground">
                                        Automation and continuous improvement of
                                        your processes
                                    </span>
                                </div>
                            </div>
                        ...
                        <div className="p-4 sm:w-1/2 w-full text-start  ">
                            ...
                            <div className="flex flex-col gap-3 py-4">
                                <div className="bg-muted rounded flex   items-center">
                                    <LucidePlay className="size-4 mr-3 fill-foreground" />
                                    <span className="text-secondary-foreground">
                                        Find the ideal supplier for your unique
                                ...
                                <div className="bg-muted rounded flex   items-center">
                                    <LucidePlay className="size-4 mr-3 fill-foreground" />
                                    <span className="text-secondary-foreground">
                                        Evaluate suppliers based on multivariate
                                        analysis
                                    </span>
                                </div>
                                <div className="bg-muted rounded flex  items-center">
                                    <LucidePlay className="size-4 mr-3 fill-foreground" />
                                    <span className="text-secondary-foreground">
                                        Add your own suppliers and suppliers
                                        from our home grown catalog
                                    </span>
                                </div>
                                <div className="bg-muted rounded flex  items-center">
                                    <LucidePlay className="size-4 mr-3 fill-foreground" />
                                    <span className="text-secondary-foreground">
                                        Ensure optimal supplier selection based
                ...
                <article className="flex flex-col md:flex-row justify-stretch items-start gap-20">
                    ...
                    <div className=" text-start flex flex-col  gap-5">
                        ...
                        <p className="text-lg text-wrap font-normal">
                            At detmo, we understand the complexities of
                            procurement management and the impact it has on your
                            organization&#39;s success. That&#39;s why we
                            created our cutting-edge procurement software—to
                            revolutionize the way you streamline your
                            operations, drive cost efficiencies, and achieve
                            procurement excellence.
                        </p>
                        <p className="text-lg text-wrap font-normal">
                            Our software&#39;s powerful spend analysis
                            capabilities and advanced sourcing projects feature
                            are designed to empower you with actionable insights
                            and enable seamless supplier selection. Join the
                            ever-growing community of satisfied customers who
                            have transformed their procurement processes with
                            our software.
                        </p>
